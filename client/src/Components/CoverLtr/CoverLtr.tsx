...
import { actionCompany } from '../../Redux/Actions'
...
function CoverLtr() {
  ...
  return (
    ...
    <div className='flex h-fit w-full flex-col bg-white my-2 rounded px-1'>
      ...
      <button type='button' title='Generate' onClick={() => NewLetter({Company: state.Company, Quality1: state.Quality1Select, Quality2: state.Quality2Select, Focus: state.FocusSelect})} 
        className='w-full bg-transparent disabled:text-gray-300 disabled:border-gray-300 hover:bg-[#4c4c74] text-blue-700 font-semibold hover:text-white py-2 px-4 my-1 border border-blue-500 hover:border-transparent rounded'
