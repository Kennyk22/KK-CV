...
function Header() {
  ...
  return (
    <header className='flex justify-center w-full h-1/2 py-[5%]'>
      <div className="p-[2%] h-full w-1/2 rounded-xl bg-[#4c4c74] items-center shadow-xl">
        <div className='h-fit w-fit p-[1%] rounded-[50%] mr-[5%] justify-center items-center bg-[#ffffff]'>
        ...
        <div className='justify-center items-center bg-white rounded-md p-[1.5%]'>
          <p className=''>
